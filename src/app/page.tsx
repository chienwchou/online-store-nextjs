  ...
  return (
    <>
      <div className="flex flex-col w-full">
        ...
        <div className="bg-red-600 text-white py-3 px-4 md:py-4 md:px-6 flex justify-between items-center">
          ...
          <div className="flex space-x-3 md:space-x-6 items-center">
            ...
            <div className="flex items-center">
              ...
              <span className="bg-white text-red-600 rounded-full h-5 w-5 md:h-6 md:w-6 flex items-center justify-center ml-1 text-xs md:text-sm">0</span>
            </div>
          </div>
        </div>
        ...
        {/* Hero banner */}
        <div className="bg-amber-50 py-6 md:py-12 px-4 md:px-8 flex flex-col md:flex-row items-center">
          <div className="w-full md:w-1/2 mb-6 md:mb-0">
            <p className="text-xl md:text-2xl mb-2 md:mb-4">Easy, Fresh & Convenient</p>
            <h2 className="text-4xl md:text-6xl font-bold mb-2 md:mb-4">Stock Up on<br />Daily Essentials</h2>
            <h3 className="text-2xl md:text-4xl font-semibold mb-4 md:mb-8">Save Big on Your<br />Favorite Brands</h3>
            <button className="bg-red-600 text-white px-4 py-2 md:px-6 md:py-3 rounded-full font-semibold">Shop Now</button>
          </div>
